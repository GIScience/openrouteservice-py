...
class DirectionsServiceBody(object):
    ...
    def language(self, language):
        ...
        :type: str
        """
        allowed_values = ["cs", "cs-cz", "da", "dk-da", "de", "de-de", "en", "en-us", "eo", "eo-eo", "es", "es-es", "fi", "fi-fi", "fr", "fr-fr", "gr", "gr-gr", "he", "he-il", "hu", "hu-hu", "id", "id-id", "it", "it-it", "ja", "ja-jp", "ne", "ne-np", "nl", "nl-nl", "nb", "nb-no", "pl", "pl-pl", "pt", "pt-pt", "ro", "ro-ro", "ru", "ru-ru", "tr", "tr-tr", "ua", "ua-ua", "vi", "vi-vn", "zh", "zh-cn"]  # noqa: E501
    ...
    def profile_name(self):
        """Gets the profile_name of this DirectionsServiceBody.  # noqa: E501


        :return: The profile_name of this DirectionsServiceBody.  # noqa: E501
        :rtype: str
        """
    ...
    def profile_name(self, profile_name):
        """Sets the profile_name of this DirectionsServiceBody.


        :param profile_name: The profile_name of this DirectionsServiceBody.  # noqa: E501
        :type: str
        """
